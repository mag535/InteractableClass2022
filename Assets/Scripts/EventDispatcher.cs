...
namespace EvtSystem
{
    ...
    public class InteractTip : Event
    {
        public Vector3 interactPosition;
        public Vector3 interactDirection;
        public float interactDistance;
    ...
    public class EventDispatcher
    {
        ...
        public delegate void EventDelegate1(Event e);
         ...
         * T is like X in an algebra equation, just a placeholder
         * "where T : Event" says that T must be of type Event
         */
        ...
        private void RemoveListener<T>(EventDelegate<T> listener) where T : Event
        {
